...
import WordpressBasicPricingCard from '../../cards/PackagesCard/WordpressCard/WordpressBasicCard/WordpressPricingCard';
import WordpressBasicPricing from '../../../arraydata/PackagesArray/WordpressArray/WordpressBasic/WordpressPricingArray';

import WordpressBasicReportCards from '../../cards/PackagesCard/WordpressCard/WordpressBasicCard/WordpressReportCards';
import WordpressBasicReports from "../../../arraydata/PackagesArray/WordpressArray/WordpressBasic/WordpressReportArray";


// standard package start
import WordpressStandardPricingCard from '../../cards/PackagesCard/WordpressCard/WordpressStandardCard/WordpressPricingCard';
import WordpressStandardPricing from '../../../arraydata/PackagesArray/WordpressArray/WordpressStandard/WordpressPricingArray';

import WordpressStandardReportCards from '../../cards/PackagesCard/WordpressCard/WordpressStandardCard/WordpressReportCards';
import WordpressStandardReports from "../../../arraydata/PackagesArray/WordpressArray/WordpressStandard/WordpressReportArray";
// standard package end


import AnimatedContent from '../../SingleComponents/AnimatedContent';

const WordpressPackage = () => {
    ...
    <>
      <div className='w-screen h-auto py-5 flex justify-center items-center !ml-[5px] '>
        <div className='w-auto h-auto flex flex-col justify-center items-center gap-2 overflow-hidden '>
          ...
          <div className="w-full h-auto p-5 flex items-center gap-10 overflow-x-auto overflow-y-hidden whitespace-nowrap scroll-Wordpressoth flex-nowrap scroll-snap-x-mandatory ">
            ...
            <div className='min-w-[360px] h-[auto] !border border-[#3030307A] rounded-[20px] flex-shrink-0 scroll-snap-center px-[20px] py-[20px] flex flex-col justify-center items-center gap-4 '>
              ...
              <div className="w-full h-auto  flex flex-col justify-start items-center gap-[20px]">
                {WordpressBasicPricing.map((data,index)=>(<WordpressBasicPricingCard key={index} plan={data.plan} pricing={data.pricing}/>))}
              </div>

              <div className="w-full h-auto flex flex-col justify-start items-center gap-[20px]">
                <div className='w-full h-auto font-raleway font-bold text-[24px] leading-snug tracking-[1px] text-start '>Features</div>
                {WordpressBasicReports.map((data,index)=>(<WordpressBasicReportCards key={index} feature={data.feature} plan={data.plan}/>))}
              </div>
            ...
            <div className='min-w-[360px] h-[auto] !border border-[#3030307A] rounded-[20px] flex-shrink-0 scroll-snap-center px-[20px] py-[20px] flex flex-col justify-center items-center gap-4 '>
              ...
              <div className="w-full h-auto  flex flex-col justify-start items-center gap-[20px]">
                {WordpressStandardPricing.map((data,index)=>(<WordpressStandardPricingCard key={index} plan={data.plan} pricing={data.pricing}/>))}
              </div>

              <div className="w-full h-auto flex flex-col justify-start items-center gap-[20px]">
                <div className='w-full h-auto font-raleway font-bold text-[24px] leading-snug tracking-[1px] text-start '>Features</div>
                {WordpressStandardReports.map((data,index)=>(<WordpressStandardReportCards key={index} feature={data.feature} plan={data.plan}/>))}
              </div>

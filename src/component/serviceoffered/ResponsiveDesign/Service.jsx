...
function Service() {
  return (
    <div className='rd-service-body'>
        <div className='rd-service-box'>
                <AnimatedContent>
            <div className='rd-service-box1'>
                <div className='rd-service-box1-heading'>
                    <div className='rd-service-box1-heading1'><p>Our <span>Responsive Website</span> Design</p>
                    <p>Service</p></div>
                    <div className='rd-service-box1-heading2'>We offer professional graphics and web design services, creating visually stunning, user-friendly designs that enhance brand identity. From logos, brochures, and social media graphics to responsive websites, we ensure creativity, functionality, and seamless user experiences tailored to your business needs.</div>
                </div>


                <div className='rd-service-box1-content1'>
                  <div className='rd-content1-image'>
                    <img src={service1}/>
                  </div>
                  <div className='rd-content1-head'>
                    <p>Mobile-First Approach</p>
                  </div>
                  <div className='rd-content1-head1'>

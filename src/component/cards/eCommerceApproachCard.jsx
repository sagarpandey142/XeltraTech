...
import "../serviceoffered/eCommerceDevelopment/eCommerceapproach.css"

function eCommerceApproachCard({icon1, icon2, logo, para}) {
  return (
...
export default eCommerceApproachCard

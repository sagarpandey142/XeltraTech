...
import "../serviceoffered/InterspireDevelopment/Interspireapproach.css"

function InterspireApproachCard({icon1, icon2, logo, para}) {
  return (
...
export default InterspireApproachCard

...
import "../../serviceoffered/EcommerceMaintenanceDevelopment/EcommerceMaintenanceapproach.css"

function EcommerceMaintenanceApproachCard({icon1, icon2, logo, para}) {
  return (
...
export default EcommerceMaintenanceApproachCard
